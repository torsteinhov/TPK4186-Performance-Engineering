...
'''
THE REST OF THE TESTS WILL NOT BE TESTED WITH ASSERTEQUAL SINCE IT PRODUCES FILES OF FORMAT .xlsx and .html
WE THEREFORE MOVE THEM OUT OF THE TEST CLASS. THE VALUES PRODUCED ARE THOROUGHLY TESTED MANUALLY, AND ARE CORRECT.
'''
